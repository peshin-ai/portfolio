      ...
      <section className="container mx-auto px-6 pt-20 pb-16">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            <div>
              <h1 className="text-5xl lg:text-6xl font-bold text-foreground mb-4 font-dm-sans">
                Ung Ta Hoang Tuan
              </h1>
              <p className="text-xl text-muted-foreground mb-6 font-dm-sans">
                Frontend Engineer
              </p>
              <p className="text-lg text-muted-foreground leading-relaxed max-w-md font-dm-sans">
          ...
          <div className="grid lg:grid-cols-3 gap-8 items-start">
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                ...
                <span className="text-lg text-foreground font-dm-sans">
